...
def is_turbospectrum_support_enabled():
    ...
    if not os.path.exists(turbospectrum_bsyn_lu) or \
...
# `enhance_solar_abundances`: required in multiple place leading to circular imports, better located in common.py
