...
double wave;
{
    static double w0[] = { 18750.954, 12818.028, 10938.047, 10049.328, 9545.928, 9228.972,
    ...
    static double Ehigh[] = { 12.74607, 13.05198, 13.21815, 13.31834, 13.38338, 13.42796,
    ...
    if (ifcore == 0 && flag == 0) {
        ...
        for (m = 4; m < 250; m++) {
            /* rad = fac*(wave0[m] - wave0[m+1]); rad = dmin(200.0,rad);
            ...
            if (fabs(wave - wave0[m]) < rad) {
                for (i = 0; i < Ntau; i++) {
                    if (m > nmax[i] || wave < Cutoff[i])
                        continue;
                    for (j = 0; j < 4; j++)
                        bkap[j][i] += gffac[m] * unified(3, m, i, 12.08716, Eh[m], model, lambda[j]);
                }
            }
        }
        flag = 1;
        ...
        for (m = 4; m < 250; m++) {
            ...
            if (fabs(wave - wave0[m]) < rad) {
                for (i = 0; i < Ntau; i++) {
                    if (m > nmax[i] || wave < Cutoff[i])
                        continue;
                    bkap[3][i] += gffac[m] * unified(3, m, i, 12.08716, Eh[m], model, lambda[3]);
                }
            }
        }
    }
        ...
        for (m = 4; m < 250; m++) {
            ...
            if (fabs(wave - wave0[m]) < rad) {
                for (i = 0; i < Ntau; i++) {
                    if (m > nmax[i] || wave < Cutoff[i])
                        continue;
                    hkap[i] += gffac[m] * unified(3, m, i, 12.08716, Eh[m], model, wave);
                }
            }
        }
        flag = 0;
...
{
    return (1.0);
    /* if(m < 14) return(1.0); else if(m == 14) return(0.9); else if(m == 15)
       return(0.8); else if(m == 16) return(0.7); else return(0.6); */

    /* if(m < 20) return(1.0); if(m == 20) return(1.2); if(m == 21)
       return(1.4); if(m == 22) return(1.6); if(m == 23) return(1.8); if(m ==
       24) return(2.0); if(m > 24) return(2.0); */
}
