...
double wave;
{
    static double w0[130] = { 1215.684, 1025.734, 972.548, 949.753, 937.814, 930.758,
    ...
    static double Ehigh[130] = { 10.198715, 12.087366, 12.748393, 13.054355, 13.220556, 13.320770,
        13.385813, 13.430406, 13.462303, 13.485904, 13.503854,
        13.517823,
        13.528907, 13.537850, 13.545168, 13.551233, 13.556316,
        13.560618,
        13.564291, 13.567451, 13.570191, 13.572581, 13.574678,
        13.576529,
        13.578171, 13.579633, 13.580942, 13.582117, 13.583177,
        13.584136,
        13.585007, 13.585799, 13.586523, 13.587186, 13.587794,
        13.588353,
        13.588869, 13.589346, 13.589787, 13.590197, 13.590578,
        13.590932,
        13.591262, 13.591571, 13.591860, 13.592131, 13.592384,
        13.592623,
        13.592847, 13.593058, 13.593257, 13.593445, 13.593623,
        13.593791,
        13.593950, 13.594101, 13.594244, 13.594380, 13.594509,
        13.594632,
        13.594749, 13.594860, 13.594966, 13.595068, 13.595165,
        13.595257,
        13.595346, 13.595430, 13.595511, 13.595589, 13.595663,
        13.595735,
        13.595803, 13.595869, 13.595932, 13.595993, 13.596051,
        13.596107,
        13.596162, 13.596214, 13.596264, 13.596312, 13.596359,
        13.596404,
        13.596448, 13.596490, 13.596530, 13.596570, 13.596608,
        13.596644,
        13.596680, 13.596714, 13.596747, 13.596780, 13.596811,
        13.596841,
        13.596870, 13.596899, 13.596927, 13.596953, 13.596979,
        13.597005,
        13.597029, 13.597053, 13.597076, 13.597099, 13.597121,
        13.597142,
        13.597163, 13.597183, 13.597202, 13.597221, 13.597240,
        13.597258,
        13.597276, 13.597293, 13.597310, 13.597326, 13.597342,
        13.597358,
        13.597373, 13.597388, 13.597402, 13.597416, 13.597430,
        13.597443,
    ...
    if (wave < 911.6 || wave > 1215.7 + lya_rad)
        return;
    if (flag1 == 0) {
        for (i = 0; i < Ntau; i++) {
            ...
            if (fabs(wave - wave0[m]) < rad) {
                for (i = 0; i < Ntau; i++) {
                    if (m > nmax[i] || wave < Cutoff[i])
                        continue;
                    for (j = 0; j < 4; j++)
                        bkap[j][i] += gffac[m] * unified(1, m, i, 0.000, Eh[m], model, lambda[j]);
                }
            }
        }
        flag = 1;
        ...
        for (m = 2; m < 130; m++) {
            ...
            if (fabs(wave - wave0[m]) < rad) {
                for (i = 0; i < Ntau; i++) {
                    if (m > nmax[i] || wave < Cutoff[i])
                        continue;
                    bkap[3][i] += gffac[m] * unified(1, m, i, 0.000, Eh[m], model, lambda[3]);
                }
            }
        }
    }
        ...
        for (m = 2; m < 130; m++) {
            ...
            if (fabs(wave - wave0[m]) < rad) {
                for (i = 0; i < Ntau; i++) {
                    if (m > nmax[i] || wave < Cutoff[i])
                        continue;
                    hkap[i] += gffac[m] * unified(1, m, i, 0.000, Eh[m], model, wave);
                }
            }
        }
        flag = 0;
