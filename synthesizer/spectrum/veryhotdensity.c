...
void veryhotDensity(atmosphere * model, atominfo * atom, double ah, double ahe, int flagw)
{
    ...
    for (i = 0; i < Ntau; i++) {
        ...
        ncI = ac * nA / (1.0 + pc2 / Ne + pc2 * pc3 / ne2 + pc2 * pc3 * pc4 / ne3 + pc2 * pc3 * pc4 * pc5 / ne4);
        nnI = an * nA / (1.0 + pn2 / Ne + pn2 * pn3 / ne2 + pn2 * pn3 * pn4 / ne3 + pn2 * pn3 * pn4 * pn5 / ne4);
        noI = ao * nA / (1.0 + po2 / Ne + po2 * po3 / ne2 + po2 * po3 * po4 / ne3 + po2 * po3 * po4 * po5 / ne4);
        nnaI = ana * nA / (1.0 + pna2 / Ne + pna2 * pna3 / ne2 + pna2 * pna3 * pna4 / ne3 + pna2 * pna3 * pna4 * pna5 / ne4);
        nmgI = amg * nA / (1.0 + pmg2 / Ne + pmg2 * pmg3 / ne2 + pmg2 * pmg3 * pmg4 / ne3 + pmg2 * pmg3 * pmg4 * pmg5 / ne4);
        nalI = aal * nA / (1.0 + pal2 / Ne + pal2 * pal3 / ne2 + pal2 * pal3 * pal4 / ne3 + pal2 * pal3 * pal4 * pal5 / ne4);
        nsiI = asi * nA / (1.0 + psi2 / Ne + psi2 * psi3 / ne2 + psi2 * psi3 * psi4 / ne3 + psi2 * psi3 * psi4 * psi5 / ne4);
        nsI = as * nA / (1.0 + ps2 / Ne + ps2 * ps3 / ne2 + ps2 * ps3 * ps4 / ne3 + ps2 * ps3 * ps4 * ps5 / ne4);
        nkI = ak * nA / (1.0 + pk2 / Ne + pk2 * pk3 / ne2 + pk2 * pk3 * pk4 / ne3 + pk2 * pk3 * pk4 * pk5 / ne4);
        ncaI = aca * nA / (1.0 + pca2 / Ne + pca2 * pca3 / ne2 + pca2 * pca3 * pca4 / ne3 + pca2 * pca3 * pca4 * pca5 / ne4);
        nfeI = afe * nA / (1.0 + pfe2 / Ne + pfe2 * pfe3 / ne2 + pfe2 * pfe3 * pfe4 / ne3 + pfe2 * pfe3 * pfe4 * pfe5 / ne4);
