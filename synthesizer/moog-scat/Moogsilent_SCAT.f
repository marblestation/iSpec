...
c*****Call the Ang_Weight_SCAT routine
	call ang_weight_SCAT !SBC: Missing call in original `Moogsilent_SCAT.f`
...
!c*****Call the Ang_Weight_SCAT routine
!	call ang_weight_SCAT !SBC This neds to be called before (moved up), as it
      !	happens in `Moog_SCAT.f`
