...
/* The new version in Synthe uses a normalization different from the original
   (which involves multiplying the profile by the factor 1.77245*dop.  This
   translation preserves the original normalization */

/* The new version was further modified Sept 9, 2008 to remove Rayleigh
   scattering cutoffs in the cores of Lyman alpha, beta, gamma and delta
   because of discontinuities in the profiles */

float propbm[7][15][5] = { {{-.980, -.967, -.948, -.918, -.873},
                            {-.968, -.949, -.921, -.879, -.821},
                            {-.950, -.922, -.883, -.830, -.764},
                            {-.922, -.881, -.830, -.770, -.706},
                            {-.877, -.823, -.763, -.706, -.660},
...
double wave;
{
    ...
    static double stalph[34] = { -730., 370., 188., 515., 327., 619., -772., -473.,
        -369., 120., 256., 162., 285., -161., -38.3, 6.82, -174., -147.,
        -101.,
        -77.5,
        55., 126., 75., 139., -60., 3.7, 27., -69., -42., -18., -5.5,
        -9.1,
        -33.,
        -24.
    };
    ...
    static double stwtal[34] = { 1., 2., 1., 2., 1., 2., 1., 2., 3., 1., 2., 1., 2., 1., 4.,
        6., 1., 2., 3., 4., 1., 2., 1., 2., 1., 4., 6., 1., 7., 6., 4.,
        4.,
        4.,
        5.
    };
    ...
    static double cutoffh2plus[111] = { -15.14, -15.06, -14.97, -14.88, -14.80, -14.71, -14.62, -14.53,
    ...
    static double cutoffh2[91] = { -13.64, -13.52, -13.39, -13.27, -13.14, -13.01, -12.87, -12.74,
    ...
    static double asumlyman[100] = { 0.000E+00, 6.265E+08, 1.897E+08, 8.126E+07, 4.203E+07, 2.450E+07,
        1.236E+07, 8.249E+06, 5.782E+06, 4.208E+06, 3.158E+06,
        2.430E+06,
        1.910E+06, 1.567E+06, 1.274E+06, 1.050E+06, 8.752E+05,
        7.373E+05,
        6.269E+05, 5.375E+05, 4.643E+05, 4.038E+05, 3.534E+05,
        3.111E+05,
        2.752E+05, 2.447E+05, 2.185E+05, 1.959E+05, 1.763E+05,
        1.593E+05,
        1.443E+05, 1.312E+05, 1.197E+05, 1.094E+05, 1.003E+05,
        9.216E+04,
        8.489E+04, 7.836E+04, 7.249E+04, 6.719E+04, 6.239E+04,
        5.804E+04,
        5.408E+04, 5.048E+04, 4.719E+04, 4.418E+04, 4.142E+04,
        3.888E+04,
        3.655E+04, 3.440E+04, 3.242E+04, 3.058E+04, 2.888E+04,
        2.731E+04,
        2.585E+04, 2.449E+04, 2.322E+04, 2.204E+04, 2.094E+04,
        1.991E+04,
        1.894E+04, 1.804E+04, 1.720E+04, 1.640E+04, 1.566E+04,
        1.496E+04,
        1.430E+04, 1.368E+04, 1.309E+04, 1.254E+04, 1.201E+04,
        1.152E+04,
        1.105E+04, 1.061E+04, 1.019E+04, 9.796E+03, 9.419E+03,
        9.061E+03,
        8.721E+03, 8.398E+03, 8.091E+03, 7.799E+03, 7.520E+03,
        7.255E+03,
        7.002E+03, 6.760E+03, 6.530E+03, 6.310E+03, 6.100E+03,
        5.898E+03,
        5.706E+03, 5.522E+03, 5.346E+03, 5.177E+03, 5.015E+03,
        4.860E+03,
        4.711E+03, 4.569E+03, 4.432E+03, 4.300E+03
    };
    static double asum[100] = { 0.000E+00, 4.696E+08, 9.980E+07, 3.017E+07, 1.155E+07, 5.189E+06,
        2.616E+06, 1.437E+06, 8.444E+05, 5.234E+05, 3.389E+05,
        2.275E+05,
        1.575E+05, 1.120E+05, 8.142E+04, 6.040E+04, 4.560E+04,
        3.496E+04,
        2.719E+04, 2.141E+04, 1.711E+04, 1.377E+04, 1.119E+04,
        9.166E+03,
        7.572E+03, 6.341E+03, 5.338E+03, 4.523E+03, 3.854E+03,
        3.302E+03,
        2.844E+03, 2.460E+03, 2.138E+03, 1.866E+03, 1.635E+03,
        1.438E+03,
        1.269E+03, 1.124E+03, 9.983E+02, 8.894E+02, 7.947E+02,
        7.120E+02,
        6.396E+02, 5.759E+02, 5.198E+02, 4.703E+02, 4.263E+02,
        3.873E+02,
        3.526E+02, 3.215E+02, 2.938E+02, 2.689E+02, 2.465E+02,
        2.264E+02,
        2.082E+02, 1.918E+02, 1.769E+02, 1.634E+02, 1.512E+02,
        1.400E+02,
        1.298E+02, 1.206E+02, 1.121E+02, 1.043E+02, 9.720E+01,
        9.066E+01,
        8.465E+01, 7.912E+01, 7.403E+01, 6.933E+01, 6.498E+01,
        6.097E+01,
        5.725E+01, 5.381E+01, 5.061E+01, 4.765E+01, 4.489E+01,
        4.232E+01,
        3.994E+01, 3.771E+01, 3.563E+01, 3.369E+01, 3.188E+01,
        3.019E+01,
        2.860E+01, 2.712E+01, 2.572E+01, 2.442E+01, 2.319E+01,
        2.204E+01,
    ...
    /* The Rydberg constant below gives consistency between the Rydberg
       ...
       it gives excellent wavelengths for Lyman and Balmer series on that basis 
     */
    ...
    if (flag1 == 0 || reset.hprofl == 1) {
        ...
        for (k = 0; k < Ntau; k++) {
            ...
            dopph[k] = sqrt(2.0 * K * model->T[k] / 1.008 / 1.660e-24 + pow(model->mtv[k], 2.0)) / 2.99792458e+10;
    ...
    if (n != n1 || m != m1) {
        ...
        gnm = xm2mn2 / xmn2;
        if (mmn <= 3 && n <= 4)
            xknm = xknmtb[mmn - 1][n - 1];
        if (mmn > 3 || n > 4)
            xknm = 5.5e-05 / gnm * xmn2 / (1.0 + 0.13 / (double)mmn);
        y1num = 320.0;
        if (m == 2)
            y1num = 550.0;
        if (m == 3)
        ...
        /* radamp = 1.389e+09/pow(xm,4.53)/(1.0 + 5.0/xm2/xm); if(n != 1)
           radamp = radamp+1.389e+09/pow(xn,4.53)/(1.0 + 5.0/xn2/xn); */
        radamp = asum[n - 1] + asum[m - 1];
        if (n == 1)
            radamp = asumlyman[m - 1];
        radamp /= 12.5664;
        radamp /= freqnm;
        resont = Hfnm(1, m) / xm / (1.0 - 1.0 / xm2);
        if (n != 1)
            resont = resont + Hfnm(1, n) / xn / (1.0 - 1.0 / xn2);
    ...
    if (ifcore == 0 || (ifcore == 1 && nwid == 1)) {
        ...
        for (i = 0; i < ifins; i++) {
            ...
            if (d <= 7.0)
                hprof4 = hprof4 + exp(-d * d) / 1.77245 / dop * finswt[i];
        }
        if (ifcore == 1)
            return (hprof4 * fnm);
    }
    ...
    if (ifcore == 0 || (ifcore == 1 && nwid == 2)) {
        if (n == 1 && m == 2) {
            /* Lyman Alpha; modify old resonance broadening to match at 4000
               cm-1 */
            hwres = hwres * 4.0;
            hwlor = hwres + hwvdw + hwrad;
            hhw = freqnm * hwlor;
            ...
            if (freq > (82259.105 - 4000.) * 2.99792458e+10)
                ...
                cutoff = 0.0;
                if (freq < 50000.0 * 2.99792458e+10)
                    hprofres = 0.0;
                else {
                    ...
                    if (freq < freq22000) {
                        ...
                        cutoff = (cutoffh2[icut + 1] - cutoffh2[icut]) / spacing * (freq - cutfreq) + cutoffh2[icut];
                    }
            ...
            /* Not Lyman alpha */
            hhw = freqnm * hwlor;
            hproflor = hhw / 3.14159 / (del * del + hhw * hhw);
            hprof4 = hprof4 + hproflor;
            if (ifcore == 1)
                return (hprof4 * fnm);
        }
    ...
    if (ifcore == 0 || (ifcore == 1 && nwid == 3)) {
        ...
        c2 = c2d[j] * c2con;
        g1 = 6.77 * sqrt(c1);
        gnot = g1 * (double)dmax(0.0, 0.2114 + log(sqrt(c2) / c1)) * (1.0 - gcon1[j] - gcon2[j]);
        beta = fabs(del) / FO[j] * dbeta;
        y1 = c1 * beta;
        y2 = c2 * beta * beta;
        gam = gnot;
        if (y2 > 0.0001 || y1 > 0.00001) {
            gam = g1 * (0.5 * exp(-(double)dmin(80.0, y1)) + Vcse1f(y1) - 0.5 * Vcse1f(y2)) * (1.0 - gcon1[j] / (1.0 + pow(90.0 * y1, 3.0)) - gcon2[j] / (1.0 + 2000.0 * y1));
            if (gam <= 1.0e-20)
                gam = 0.0;
        }
        ...
        if (m <= 2) {
            ...
            if (freq >= (82259.105 - 20000.0) * 2.99792458e+10) {
                if (freq <= (82259.105 - 4000.0) * 2.99792458e+10) {
                    ...
                    if (freq < freq15000)
                        cutoff = cutoffh2plus[0] + (freq - freq15000)
                            * (cutoffh2plus[1] - cutoffh2plus[0]) / spacing;
                    else {
                        icut = (freq - freq15000) / spacing;
                        cutfreq = icut * spacing + freq15000;
                        cutoff = (freq - cutfreq) * (cutoffh2plus[icut + 1] - cutoffh2plus[icut]) / spacing + cutoffh2plus[icut];
                    }
        ...
        f = 0.0;
        if (gam > 0.0)
            f = gam / 3.14159 / (gam * gam + beta * beta);
        p1 = pow(0.9 * y1, 2.0);
...
double x;
{
    ...
    if (x <= 1.0) {
        vcse1f = -log(x) - 0.57721566 + x * (0.99999193 + x * (-0.24991055 + x * (0.05519968 + x * (-0.00976004 + x * 0.00107857))));
        return (vcse1f);
    }
    if (x <= 30.0) {
...
int n, m;
{
    ...
    if (b <= 500) {
        ...
        if (b <= 25.12) {
            ...
            wtbm = 1.0 - wtbp;
            cbp = propbm[indx - 1][jp][ip - 1] * wtpp + propbm[indx - 1][jp][im - 1] * wtpm;
            cbm = propbm[indx - 1][jm][ip - 1] * wtpp + propbm[indx - 1][jm][im - 1] * wtpm;
...
double freq;
{
    ...
    wn = freq / c;
    wn2 = wn * wn;
    n = 1.0 + 6432.8e-08 + 2949810.0 / (146.0e+08 - wn2) + 25540.0 / (41.0e+08 - wn2);
    wnair = wn * n;
    return (wnair * c);
}
