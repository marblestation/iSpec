...
int l, m, n;
{
    ...
    for (j = 0; j < l; j++) {
        if (j >= l1 && j <= lll)
            polynn2(x1a, x2a, ya[j], m, n, x1, x2, &ymtmp[j]);
        else
            ymtmp[j] = 0.0;
    }
...
int m, n, *jh, *kh;
{
    ...
    for (j = 0; j < m; j++) {
        if (j >= l && j <= lll)
            opolynn(x2a, ya[j], n, x2, &ymtmp[j], kh);
        else
            ymtmp[j] = 0.0;
    }
...
int l, m, n, *ih, *jh, *kh;
{
    ...
    for (j = 0; j < l; j++) {
        if (j >= l1 && j <= lll)
            opolynn2(x1a, x2a, ya[j], m, n, x1, x2, &ymtmp[j], jh, kh);
        else
            ymtmp[j] = 0.0;
    }
