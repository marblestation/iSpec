...
c     P(H)  = p(H) + p(H+) + 2p(H_2) + p(CH) + p(NH) + p(OH) + p(MgH) + 2p(H_2O)
...
c     P(Ti) = p(Ti) + p(Ti+) + p(TiO)
     ...
     .     101.0,   106.0,   107.0,   108.0,   112.0,   606.0,
     .     607.0,   608.0,   707.0,   708.0,   808.0, 10108.0,
     .   60808.0,   812.0,   822.0,
     .    89*0.0/
...
c     p(Fe) = p(Fe) + p(Fe+) + p(FeH) + p(FeO)                
     ...
     .      22.1,    23.1,    24.1,    26.1,                  
     .     101.0,   106.0,   107.0,   108.0,   112.0,   113.0,   
     .     114.0,   115.0,   116.0,   117.0,   120.0,   124.0,   
     .     126.0, 10106.0, 10107.0, 10108.0, 10115.0, 10116.0, 
     .   10608.0, 10812.0, 10813.0, 10820.0,   606.0,   607.0,  
     .     608.0,   616.0, 60808.0,   707.0,   708.0,   714.0,   
     .     715.0,   716.0,   808.0,   812.0,   814.0,   815.0,   
     .     816.0,   822.0,   823.0,   826.0,  1416.0,         
     .     53*0.0/ 
